...
export class AttendanceServiceManager {
  ...
  // GET /api/Attendances (Manager Only)
  ...
  updateAttendance(id: number, data: Attendance): Observable<Attendance> {
    const url = `${this.apiUrl}/${id}`;
    return this.http.put<Attendance>(url, data);
}
}